...
| --- | --- | --- | --- |
| Country-aware gallery and offer discovery | `625181e`, `20f6a02`, related source, migrations, scripts, and tests | Superseded in part; no wholesale port | Current `master` retains the shared country-aware EarnLab importer, provider identity strategy, and public offer-country filtering. The archived cookie selector and older Gemsloot country routes must be reviewed only as an architecture-specific enhancement. |
