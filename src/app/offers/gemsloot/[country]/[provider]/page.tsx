...
export function generateMetadata({ params }: PageProps): Metadata {
  ...
  return { title: `${provider.label} Gemsloot Offers in ${country.name} | EarnGrind`, description: `Browse imported ${provider.label} offers available through Gemsloot in ${country.name}. Compare rewards, tasks, and start through Gemsloot.`, alternates: { canonical: `/offers/gemsloot/${country.slug}/${provider.slug}` } };
}
