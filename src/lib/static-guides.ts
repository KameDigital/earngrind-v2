...
export const STATIC_GUIDES: StaticGuide[] = [
    ...
    },
    {
        ...
        slug: "state-of-survival-zombie-war-torox-guide",
        href: "/guides/state-of-survival-zombie-war-torox-guide",
        contentType: "offer_guide",
        gameSlug: "state-of-survival-zombie-war",
        imageUrl: "https://www.appbrain.com/stats/libraries/image/com.kingsgroup.sos",
        indexLabel: "State of Survival",
        initials: "SOS",
        difficulty: "hard",
        estimatedTime: "22 days",
        maxPayoutUsd: 275.451,
        eyebrow: "New Torox Android guide",
        description:
            "Complete the State of Survival: Zombie War Torox offer, plan 275,451 points, compare HQ and power goals, and protect purchase proof.",
        ctaLabel: "Read State of Survival Guide",
        accentClassName: "border-emerald-200 bg-emerald-50 text-emerald-800",
        buttonClassName: "bg-slate-950 text-emerald-200",
        lastModified: "2026-05-30",
        sitemapPriority: 0.82,
    ...
    {
        title: "FanDuel Sportsbook Referral Bonus Guide",
        slug: "fanduel-sportsbook-referral-bonus",
        href: "/guides/fanduel-sportsbook-referral-bonus",
        contentType: "offer_guide",
        imageUrl: "/images/guides/fanduel-casino/fanduel-bonus-hero.png",
        indexLabel: "FanDuel Sportsbook",
        initials: "FD",
        difficulty: "easy",
        estimatedTime: "First bet must settle within 30 days",
        maxPayoutUsd: null,
        eyebrow: "New Sportsbook referral guide",
        description:
            "Use the FanDuel Sportsbook referral link, follow the $5 deposit and settled-bet steps, and check current Bonus Bet terms before signing up.",
        ctaLabel: "Read FanDuel Referral Guide",
        accentClassName: "border-blue-200 bg-blue-50 text-blue-800",
        buttonClassName: "bg-[#1167d8] text-white",
