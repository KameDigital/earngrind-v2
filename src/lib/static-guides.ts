...
export const STATIC_GUIDES: StaticGuide[] = [
    {
        title: "Lords Mobile Guide",
        slug: "lords-mobile",
        href: "/guides/lords-mobile",
        contentType: "game_guide",
        gameSlug: "lords-mobile",
        imageUrl: "https://play-lh.googleusercontent.com/oEx9N3xTb-1xRgoYoAEV3TA5L0nwJT0jlSG9lBCOjVIuU6-rN9lYfpiU4uDs3yPKuHU=w240-h480",
        indexLabel: "Lords Mobile",
        initials: "LM",
        difficulty: "medium",
        estimatedTime: "Beginner to midgame",
        maxPayoutUsd: null,
        eyebrow: "New strategy game guide",
        description:
            "Learn Lords Mobile castle upgrades, Academy research, heroes, troops, guilds, Monster Hunt, spending, codes, and fast progression.",
        ctaLabel: "Read Lords Mobile Guide",
    ...
    {
        title: "Lords Mobile CPAlead Offer Guide",
        slug: "lords-mobile-cpalead-offer-guide",
        ...
        maxPayoutUsd: 383.653,
        eyebrow: "New CPAlead Android guide",
        description:
            "Complete the Lords Mobile CPAlead offer. Task payouts, Academy and Character level routes, purchase timing, and proof steps.",
        ctaLabel: "Read CPAlead Guide",
        accentClassName: "border-cyan-200 bg-cyan-50 text-cyan-800",
        buttonClassName: "bg-slate-950 text-cyan-200",
        lastModified: "2026-05-31",
    ...
    },
    {
        ...
        slug: "raid-shadow-legends-earnlab-offer-guide",
        href: "/guides/raid-shadow-legends-earnlab-offer-guide",
        contentType: "offer_guide",
        indexLabel: "Raid: Shadow Legends",
        initials: "RS",
        imageUrl: "/images/guides/gpt-sites/earnlab.png",
        difficulty: "hard",
        estimatedTime: "60 days",
        maxPayoutUsd: 372.716,
        eyebrow: "New EarnLab Android guide",
        description:
            "Complete the Raid: Shadow Legends EarnLab Android offer, plan 372,716 points, compare purchases, Sacred Shards, hero ranks, and Level 70 stop rules.",
        ctaLabel: "Read EarnLab Raid Guide",
